...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [436670.488605, 1160099.035310, 437489.706084, 1160668.672720], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:5899',
            extent: [436738.170000, 1160236.440000, 437073.530000, 1160536.610000],
            units: 'm'})
    })
});
...
map.getView().fit([436670.488605, 1160099.035310, 437489.706084, 1160668.672720], map.getSize());
